...
import {
    ...
    shareScreen,
    stopShareScreen,
} from '~/container/VideoConference/utils'
...
const VideoConferenceSection = ({ userData, roomId }: Props) => {
    const {
    ...
    useEffect(() => {
        ...
        ;(async function () {
            ...
            if (errMsg) {
                ...
                clearPeerConnections()
                router.push(`/mentor-profile/${roomId}`)
                return
            }
        ...
        <div className="flex h-screen flex-col bg-zinc-800">
            ...
            <div className="mt-5 flex h-20 justify-center gap-10">
                ...
                <PiChatCircleText
                    ...
                    className="h-14 w-14 cursor-pointer rounded-full bg-gray-200 p-3"
                />
                <Link href={`/mentor-profile/${roomId}`}>
                    <ImPhoneHangUp
                        onClick={() => {
                            if (
