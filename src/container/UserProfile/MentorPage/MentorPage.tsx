...
import { Discipline, Skill, Tool } from './types'
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-4">
                                ...
                                <div className="pt-6">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <p className="text-muted-foreground">
                                            {userData.user.primaryExpertise}
                                        </p>
                        ...
                        <Card
                            ...
                            onClick={() => {}}
                            content={<p>{userData.user.introduction}</p>}
                        />
                    </div>
                    ...
                    <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <Card
                            ...
                            onClick={() => {}}
                            content={<p>{userData.user.primaryExpertise}</p>}
                        />
                        ...
                        <Card
                            ...
                            onClick={() => {}}
                            content={<p>{userData.user.secondaryExpertise}</p>}
                        />
                    </div>
                    ...
                    <Card
                        ...
                        content={
                            <div className="flex flex-wrap gap-2">
                                {userData.user.mentorDisciplines.map(
                    ...
                    <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <Card
                            ...
                            content={
                                <div className="flex flex-wrap gap-2">
                                    {userData.user.mentorSkills.map(
                                        (skill: Skill) => (
                                            <Badge
                                                key={skill.id}
                                                variant="outline"
